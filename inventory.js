...
function initInventoryUI(scene) {
  ...
  // ── Populate items inside the container ──────────────────────────────
  items.forEach((item, i) => {
    ...
    // Drag: reposition relative to the container
  ...
  // ── Drag-handler: title bar moves entire panel ───────────────────────
