...
function initEquipmentUI(scene) {
  ...
  // Live preview container (centered inside panel)
  ...
  // Drag logic (drag the bar, move entire panel)
  ...
  // Handle drop ‐ update slot icon & live preview
